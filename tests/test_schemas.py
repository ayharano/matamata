...
def test_winner_payload_schema():
    schema = WinnerPayloadSchema(winner_uuid="01234567-89ab-cdef-0123-456789abcdef")
...
def test_competitor_schema():
    schema = CompetitorSchema(
        **{"uuid": "5d1bd1d1-2679-432a-ac11-ebfebfa1bce9", "label": "South Korea"}
    )
...
def test_tournament_start_schema():
    schema = TournamentStartSchema(
        **{
            ...
            "competitors": [
                {"uuid": "de686e37-804b-4815-a507-d5879a240af6", "label": "Germany"},
                {
                    "uuid": "5d1bd1d1-2679-432a-ac11-ebfebfa1bce9",
                    "label": "South Korea",
                },
                {"uuid": "7f026276-0904-4a7b-ae14-8c66b95ffc9e", "label": "Brazil"},
                {"uuid": "15f4fe33-f317-4c4a-96e0-3b815dc481c6", "label": "Turkey"},
            ],
            "matches": [
                {
